...
struct INFO {
  String arduino_ip = "192.168.125.220";
...
String msg_names[] = {"MSG_RECEIVED" , "MSG_EXECUTED", "MSG_STOP", "MSG_INFO", "MSG_DODATA", "MSG_MOTORDATA", "MSG_MOTORSTATE", "MSG_RESET"};
